...
const DishDetailScreen = () => {
    ...
    return (
        ...
        <Card>
            ...
            <div>
                {dishLoading === false && <StyledTable className="table-striped-rows"
                    columns={columns}
